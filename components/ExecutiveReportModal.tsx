    ...
    printWindow.document.write(`
      ...
      <html>
        ...
        <body>
          ...
          ${htmlContent}
          <div class="footer">
            Generated by Karez 2.0 — AI-Native PPRA Compliance Engine | 
            This document is a compliance assistance tool. Final verification 
            responsibility rests with the bidding team.
          </div>
        </body>
      </html>
    `);
